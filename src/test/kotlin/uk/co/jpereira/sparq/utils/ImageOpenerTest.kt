...
class ImageJOpenImageDummy : ImageJOpenImage {
    override fun process(imagePath: String): ImagePlus {
        return fail<ImagePlus>("Should not have been called")
    }
}
...
class BioFormatOpenImageDummy : BioFormatOpenImage {
    override fun process(options: ImporterOptions): Array<ImagePlus> {
        return fail<Array<ImagePlus>>("Should not have been called")
    }
...
internal class ImageOpenerTest {
    @Test
    fun `when image is tif and selected channel is RED, returns first and third image`() {
    ...
    @Test
    fun `when image is tif and selected channel is Green, returns first and third image`() {
        val image = ImagePlus("some-image", BufferedImage(10, 10, 10))
        val redImage = createRGBImage("red-image")
        val greenImage = createRGBImage("green-image")
        val blueImage = createRGBImage("blue-image")
    ...
    @Test
    fun `when image is zvi and selected channel is GREEN, returns first and third image`() {
        val image = ImagePlus("some-image", BufferedImage(10, 10, 10))
        val redImage = createRGBImage("red-image")
        val greenImage = createRGBImage("green-image")
        val blueImage = createRGBImage("blue-image")
    ...
    @Test
    fun `when image is lif and selected channel is GREEN, returns first and third image`() {
        val redImage1 = createRGBImage("red-image-1")
        val greenImage1 = createRGBImage("green-image-1")
        val blueImage1 = createRGBImage("blue-image-1")
        val redImage2 = createRGBImage("red-image-2")
